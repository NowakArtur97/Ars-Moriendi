...
public class PlayerBowFireArrowShotStateOld : PlayerAttackState
{
    ...
    public PlayerBowFireArrowShotStateOld(Player player, PlayerFiniteStateMachine playerFiniteStateMachine, D_PlayerData playerData,
